...
mkdir /opt/kibana/kibana_passwords.txt
...
echo "Login to Kibana via http://kibana-ip:5601 and use the elastic password found in /opt/kibana/kibana_passwords.txt"